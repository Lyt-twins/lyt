...
public class FileManager {
	...
	private static void fileList(String path) {
       ...
       File[] fileList = file.listFiles();   // 하위 경로의 파일 목록을 File[]배열로 변환
	 ...
	 * @param path
	 */
	// mkdir() : 생성 할 경로의 상위 경로까지 기존 디렉토리가 존재해야한다.  (없으면 에러)
	// mkdirs() : 생성 할 경로의 상위 경로까지 디렉토리를 생성해준다.
