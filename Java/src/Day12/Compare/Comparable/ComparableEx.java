...
public class ComparableEx {
	...
	public static void main(String[] args) {
		...
		bookList.add( new Book("책2", "저자2", 5000) );
		bookList.add( new Book("책3", "저자3", 4000) );
		bookList.add( new Book("책4", "저자4", 2000) );
		bookList.add( new Book("책5", "저자5", 1000) );
		...
		//정렬
		//* Book 클래스에 구현한 compareTo() 메소드의 비교기준에 다라 정렬된다.
